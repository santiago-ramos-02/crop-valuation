...
test("capitalized equilibrium applies the discount rate to unrecovered net flows", () => {
  assert.equal(capitalizedEquilibriumAgeFromAnnualFlows(multiHarvestRecoveryFlows, 0), 3.8)
  assert.equal(capitalizedEquilibriumAgeFromAnnualFlows(multiHarvestRecoveryFlows, 0.1), null)
})
